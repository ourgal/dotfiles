...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "fzf") "opt" (list "shell" "bash" "fzf" "enable") "os" (list "linux" "android")) | atoi -}}
...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "starship") "opt" (list "shell" "bash" "starship" "enable") "os" (list "linux" "android")) | atoi -}}
...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "oh-my-posh") "opt" (list "shell" "bash" "oh_my_posh" "enable") "os" (list "linux" "android")) | atoi -}}
...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "atuin") "opt" (list "shell" "bash" "atuin" "enable") "os" (list "linux" "android")) | atoi -}}
...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "mcfly") "opt" (list "shell" "bash" "mcfly" "enable") "os" (list "linux" "android")) | atoi -}}
...
#+begin_src bash
{{ if includeTemplate "opt" (dict "chezmoi" .chezmoi "my" .my "cmd" (list "bash" "zoxide") "opt" (list "shell" "bash" "zoxide" "enable") "os" (list "linux" "android")) | atoi -}}
